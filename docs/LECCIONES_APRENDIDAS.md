...
- **13/08 — Un chequeo que grita "no coincide" puede estar midiendo un cambio deliberado.** Los agujeros de la plantilla nueva caian hasta 56 mm de los del patron. En vez de "corregir", mostre la tabla y pregunte: Fak los habia movido el, contorno incluido. **El chequeo frena, no decide** — y el orden correcto es medir, mostrar el numero crudo, preguntar. (Antes de eso arme dos comparaciones invalidas: un split de piezas que dejo un agujero en X negativa, y un cotejo de bbox entre dos objetos que no son la misma cosa. **Una comparacion que no puedo justificar geometricamente no es evidencia**; la buena fue la de separaciones entre agujeros, invariante a traslacion y a como yo parta el archivo.)
