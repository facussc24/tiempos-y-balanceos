#!/usr/bin/env bash
# consumos-entregable-guard.sh — wrapper fino. Desde el 05/09/2026 la logica vive en
# scripts/_lib/guardianes.mjs (guardian "consumos-entregable-guard"), junto con la de los otros doce: el
...
# Antes: consumos-entregable-guard.sh — Enforcement de las lecciones 2026-07-14/16
#
...
#   printf '%s' "$JSON" | bash .claude/hooks/consumos-entregable-guard.sh      # exit 0 pasa · exit 2 bloquea
...
exec node "$RAIZ/scripts/_lib/guardianes.mjs" --solo consumos-entregable-guard
