...
- **Headrest Front vs Rear NO tienen el mismo proceso** (HF: EPP+varilla, 16 OPs con enfundado; HRC/HRO: solo varilla, 14 OPs directo a PU). NO flaggear como desincronizacion ni sugerir alinear estructuras. SI alinear severidades de fallas comunes mal calibradas.
