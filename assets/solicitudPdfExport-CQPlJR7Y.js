import{S as w}from"./SolicitudApp-BsriUNI2.js";import{sanitizeFilename as S}from"./filenameSanitization-D6J-gYyb.js";import{g as m}from"./ppeBase64-CPS3e8wN.js";import{r as A,a as E}from"./pdfRenderer-TULRQuX_.js";import"./index-D3ibxlAl.js";import"./charts-aD-cZeRc.js";import"./supabase-hwi2RHdP.js";import"./useAmfeConfirm-Ynr1QjsH.js";import"./ConfirmModal-BhmtyoFs.js";import"./useFocusTrap-CK6FNcvv.js";import"./info-CwO2y2u4.js";import"./trash-2-DrMRpHcP.js";import"./x-e1uIing0.js";import"./plus-DRBkVMfi.js";import"./wifi-CQ-ib1QD.js";import"./wifi-off-Jtw6YKC0.js";import"./arrow-left-C5QKE2jP.js";import"./save-xULM0G6J.js";import"./file-down-DcwL0YKd.js";import"./ellipsis-D3kRdRQ-.js";import"./useOpenExportFolder-C7D7QTkr.js";import"./folder-output-BDgRykft.js";import"./shield-check-rxQx_dtX.js";import"./circle-alert-Cp45lYrF.js";import"./image-CFlGfq29.js";import"./file-MvfIoFPC.js";import"./useRevisionControl-Cl8q9wf9.js";import"./chevron-up-DwOcu_fE.js";import"./chevron-down-tnPVMgn-.js";import"./eye-BH_hGYZK.js";import"./Breadcrumb-BOtQH6dk.js";const p="#D97706",c="#92400E";function e(t){return t==null||t===""?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function O(t){if(!t)return"";const o=t.split("-");return o.length!==3?t:`${o[2]}/${o[1]}/${o[0]}`}function r(t,o){return`
        <tr>
        ...
        <div style="font-family:Arial,sans-serif; max-width:700px; margin:0 auto; padding:20px;">
            ...
            ${h}
            ${$}
        </div>`}async function dt(t){const o=await m();return b(t,o)}async function rt(t){const o=await m(),i=b(t,o);return E(i,{paperSize:"a4",orientation:"portrait",margin:[15,15,15,15]})}async function pt(t){const o=await m(),i=b(t,o),d=t.header.solicitudNumber||t.producto?.codigo||t.insumo?.codigo||"Solicitud",n=S(d,{allowSpaces:!0}),a=new Date().toISOString().split("T")[0],s=`Solicitud_${n}_${a}.pdf`;await A(i,{filename:s,paperSize:"a4",orientation:"portrait",margin:[15,15,15,15]})}export{pt as exportSolicitudPdf,rt as generateSolicitudPdfBuffer,dt as getSolicitudPdfPreviewHtml};
