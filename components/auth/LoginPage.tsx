            ...
            <div className="w-full max-w-sm">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {error && (
                            <div className="flex items-start gap-2.5 p-3 bg-red-950/50 border border-red-800/50 rounded-lg" role="alert">
                                <svg className="w-4 h-4 text-red-400 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
