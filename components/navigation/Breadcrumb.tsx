                ...
                <React.Fragment key={index}>
                    ...
                    {item.onClick && !item.isActive ? (
                        <button
                            ...
                            className="px-2 py-1 text-slate-500 hover:text-blue-600 hover:bg-blue-50 hover:shadow-sm hover:-translate-y-px rounded transition-all truncate max-w-[150px]"
                            title={item.label}
                        >
                        ...
                        <span
                            className={`px-2 py-1 truncate max-w-[150px] ${item.isActive
