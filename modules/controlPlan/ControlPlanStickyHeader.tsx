    ...
    return (
        <thead className="sticky top-0 z-10 shadow-md text-xs font-semibold text-slate-700">
            ...
            <tr className="border-b border-gray-300">
                {showProceso && (
                    <th colSpan={4} className="bg-teal-200 px-3 py-2 text-center min-w-[510px] border-r border-teal-300 font-bold text-teal-900">
                        PROCESO
                    </th>
                )}
                {showCaract && (
                ...
                {showMetodos && (
                    <>
                        ...
                        <th className="bg-sky-50 p-2 w-32 border-r border-gray-300">
                            <HeaderWithTip termKey="controlProcedure" label="Plan Reacción ante Descontrol" />
                        </th>
                    </>
                )}
            </tr>
