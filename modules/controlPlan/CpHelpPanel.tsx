...
const CP_COLUMN_INFO = [
    { group: 'Proceso', items: [
        { col: 'Nro. Parte/Proceso', required: true, autoFill: false, desc: 'Numero de referencia del paso del proceso. Tomado del diagrama de flujo.' },
        { col: 'Descripcion Proceso', required: true, autoFill: false, desc: 'Descripcion de la operacion. Debe coincidir con diagrama de flujo y AMFE.' },
        { col: 'Maquina/Dispositivo', required: false, autoFill: false, desc: 'Equipo, maquina o herramienta utilizada en la operacion.' },
    ]},
    { group: 'Caracteristicas', items: [
        { col: 'Nro. Caracteristica', required: false, autoFill: false, desc: 'Numero de referencia cruzada con plano y AMFE.' },
        { col: 'Producto', required: true, autoFill: false, desc: 'Propiedad/dimension del producto medida tras el proceso.' },
        { col: 'Proceso', required: false, autoFill: false, desc: 'Variable de proceso con relacion causa-efecto con el producto.' },
        { col: 'Clasif. Caract. Esp.', required: false, autoFill: false, desc: 'CC (Critica, S>=9) o SC (Significativa, S=5-8) per IATF 16949.' },
    ]},
    { group: 'Metodos', items: [
        { col: 'Especificacion/Tolerancia', required: false, autoFill: false, desc: 'Rango de aceptacion. NUNCA auto-llenado (viene de ingenieria de diseño).' },
        { col: 'Tecnica Evaluacion', required: false, autoFill: true, desc: 'Sistema de medicion (calibre, CMM, visual, etc.). Sugerido por IA.' },
        { col: 'Tamaño Muestra', required: true, autoFill: true, desc: 'Cantidad de piezas por muestreo. Auto-llenado segun AP y fase.' },
        { col: 'Frecuencia', required: false, autoFill: true, desc: 'Periodicidad del muestreo. Auto-llenado segun AP y fase.' },
        { col: 'Metodo Control', required: true, autoFill: true, desc: 'Poka-Yoke, SPC, checklist, etc. Obligatorio para CC/SC y AP=H.' },
        { col: 'Plan Reaccion', required: true, autoFill: true, desc: 'Acciones correctivas ante no conformidad. Auto-llenado segun severidad.' },
        { col: 'Responsable Reaccion', required: true, autoFill: false, desc: 'Persona en piso. NUNCA auto-llenado. Obligatorio per CP 2024.' },
    ]},
];
