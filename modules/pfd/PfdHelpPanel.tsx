...
const PfdHelpPanel: React.FC<Props> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
            <div className="bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-2xl max-h-[85vh] flex flex-col">
                {/* Header */}
                ...
                <div className="flex-1 overflow-y-auto">
                    <Section title="¿Qué es el Diagrama de Flujo del Proceso?" icon={<HelpCircle size={14} />} defaultOpen>
                        <p>
                            El <strong>Diagrama de Flujo del Proceso (PFD)</strong> es un documento obligatorio de AIAG APQP
                        ...
                        <p>
                            ...
                            Cada operación del PFD se convierte en una línea del AMFE y del Plan de Control.
                        </p>
                        <p className="text-cyan-700 font-medium">
                            Norma de referencia: Formulario I-AC-005.1 del SGC Barack Mercosul.
                        </p>
                    </Section>
                    ...
                    <Section title="Integración con AMFE y Plan de Control" icon={<GitMerge size={14} />}>
                        ...
                        <div className="flex items-center gap-2 justify-center py-2 text-[11px] font-medium">
                            <span className="bg-cyan-100 text-cyan-800 px-2 py-1 rounded">PFD</span>
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-2 text-[11px]">
                            <li>Cada operación del PFD genera una fila en el AMFE de Proceso.</li>
                            <li>Las CC/SC del PFD deben aparecer en el AMFE y en el Plan de Control.</li>
                            <li>Los procesos de retrabajo del PFD deben analizarse en el AMFE.</li>
                            <li>Los campos Máquina/Dispositivo del PFD alimentan las 4M del AMFE.</li>
                        </ul>
                    </Section>
                </div>
                ...
                <div className="px-5 py-2 border-t border-gray-200 bg-gray-50 rounded-b-xl">
                    <p className="text-[10px] text-gray-400 text-center">
                        Referencia: AIAG APQP §3.1 · IATF 16949:2016 · VDA 6.3 · Formulario I-AC-005.1
                    </p>
                </div>
            </div>
        </div>
