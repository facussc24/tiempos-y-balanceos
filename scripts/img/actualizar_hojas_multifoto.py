# -*- coding: utf-8 -*-
"""
Script maestro para actualizar generar_hojas_img.py con:
  - Eliminación total de la hoja de calidad (Fak: "sacala, no soy calidad, que la haga calidad").
  - Layouts multi-foto secuenciales (2x2 y 1x2 con badges de pasos) para que la operación se entienda paso a paso.
  - 10 operaciones de ingeniería y manufactura (30.1 a 30.10) + Portada = 11 láminas en total.
"""
import os
import sys
...
def bloque_imagenes(slide, imagenes, badges=None):
    ...
    if n == 1:
        ...
        # Grilla 2x2 secuencial perfecta
        cw = (W_util - 0.20) / 2
        ch = (H_util - 0.20) / 2
        for k, ruta in enumerate(imgs_ok):
            col = k % 2
...
HOJAS_IMG = [
    ...
    dict(
        ...
        imagenes=[
            r"C:\Dev\_telefono\2026-09-04\_frames\IMG_0645\IMG_0645_0001.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.4_d_avance_selectores.jpg"
        ],
        badges=["Paso 1-4: Gabinete", "Paso 5: Suministros"],
        pasos=[
    ...
    dict(
        ...
        imagenes=[
            r"C:\Dev\_telefono\2026-09-04\_frames\IMG_0645\IMG_0645_0311.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.7_d_vacio_conformado.jpg"
        ],
        badges=["Paso 1-2: Login PIN", "Paso 3-5: Receta"],
        pasos=[
    ...
    # ── FASE 2: MANEJO DE ROLLO Y ALIMENTACIÓN (4 FOTOS SECUENCIALES) ──
    dict(
        op="30.3",
        denominacion="MONTAJE DEL ROLLO DE TPO EN EL DESBOBINADOR",
        imagenes=[
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.3_a_introducir_eje.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.3_b_centrado_eje.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.3_c_montaje_soportes.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.3_d_freno_desbobinador.jpg"
        ],
        badges=["Paso 1-2: Buje", "Paso 3: Centrado", "Paso 4: Calzado", "Paso 5: Freno"],
        pasos=[
            ...
            "Calzar el eje entre dos operarios sobre los soportes del desbobinador y habilitar el freno neumático de tensión."
        ],
    ...
    dict(
        ...
        imagenes=[
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.4_a_rodillos_tensores.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.4_b_carlos_aplanado.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.4_c_guia_escuadra.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.4_d_avance_selectores.jpg"
        ],
        badges=["Paso 1-2: Rodillos", "Paso 3: Aplanado", "Paso 4: Escuadra", "Paso 5: Tracción"],
        pasos=[
            ...
            "Accionar el avance con el selector de alimentación hasta posicionar el material en el marco tensor, comprobando que no se generen pliegues."
        ],
    ...
    dict(
        ...
        imagenes=[
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.5_a_fin_material.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.5_b_retiro_buje.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.5_c_nueva_bobina.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.5_d_reenhebrado.jpg"
        ],
        badges=["Paso 1: Fin Lámina", "Paso 2: Retiro Buje", "Paso 3-4: Nueva Bobina", "Paso 5: Re-enhebrado"],
        pasos=[
            ...
            "Enhebrar la punta de la nueva lámina a través de los rodillos según hoja 30.4 y reanudar el avance hasta restablecer el ciclo."
        ],
    ...
    # ── FASE 3: OPERACIÓN EN MODO AUTOMÁTICO (4 FOTOS SECUENCIALES) ──
    dict(
        op="30.6",
        denominacion="INSPECCIÓN Y LIMPIEZA DE CAVIDAD DE MOLDE VERDE",
        imagenes=[
            r"C:\Dev\_telefono\2026-09-03\_frames\IMG_0631\IMG_0631_0015.jpg",
            r"C:\Dev\_telefono\2026-09-03\_frames\IMG_0631\IMG_0631_0005.jpg"
        ],
        badges=["Paso 1-3: Cavidad", "Paso 4-5: Sellos y Guías"],
        pasos=[
    ...
    dict(
        ...
        imagenes=[
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.7_a_bimanual.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.7_b_descenso_portico.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.7_c_cierre_marco.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.7_d_vacio_conformado.jpg"
        ],
        badges=["Paso 1-2: Bimanual", "Paso 3: Calentamiento", "Paso 4: Clamps", "Paso 5: Vacío"],
        pasos=[
    ...
    dict(
        ...
        imagenes=[
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.8_a_enfriamiento.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.8_b_apertura_carro.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.8_c_pieza_en_molde.jpg",
            r"c:\Dev\BarackMercosul\scripts\img\assets\30.8_d_extraccion_pieza.jpg"
        ],
        badges=["Paso 1: Enfriamiento", "Paso 2-3: Elevación", "Paso 4: Pieza en Molde", "Paso 5: Desmolde"],
        pasos=[
        ...
        nota="No tirar con violencia ni retorcer la pieza mientras conserve calor para evitar deformaciones en el perfil.",
        epp=EPP_STD,
    ...
    dict(
        ...
        imagenes=[
            r"C:\Dev\_telefono\2026-09-04\_frames\IMG_0663\IMG_0663_0010.jpg",
            r"C:\Dev\_telefono\2026-09-04\_frames\IMG_0664\IMG_0664_0071.jpg"
        ],
        badges=["Paso 1-3: Desconexión", "Paso 4-5: Cadenas Grúa"],
        pasos=[
    ...
    dict(
        ...
        imagenes=[
            r"C:\Dev\_telefono\2026-09-04\_frames\IMG_0666\IMG_0666_0015.jpg",
            r"C:\Dev\_telefono\2026-09-04\_frames\IMG_0666\IMG_0666_0045.jpg"
        ],
        badges=["Paso 1-3: Alineación Carro", "Paso 4-5: Bloqueo en Cama"],
        pasos=[
...
print("generar_hojas_img.py actualizado con 11 láminas y grillas multi-foto.")
