...
describe('useControlPlan', () => {
    ...
    describe('loadData', () => {
        it('replaces entire document', () => {
            ...
            const doc: ControlPlanDocument = {
                header: { controlPlanNumber: '', phase: 'production' as const, partNumber: 'ABC', latestChangeLevel: '', partName: '', organization: 'Test Org', supplier: '', supplierCode: '', keyContactPhone: '', date: '', revision: '1', responsible: 'Juan', approvedBy: '', plantApproval: '', client: 'Toyota', coreTeam: '', customerApproval: '', otherApproval: '', linkedAmfeProject: '', applicableParts: '' },
                items: [{ id: 'loaded-1', processStepNumber: '10', processDescription: 'Op', machineDeviceTool: '', componentMaterial: '', characteristicNumber: '', productCharacteristic: '', processCharacteristic: '', specialCharClass: '', specification: '', evaluationTechnique: '', sampleSize: '', sampleFrequency: '', controlMethod: '', reactionPlan: '', reactionPlanOwner: '', controlProcedure: '' }],
            };
    ...
    describe('setItems', () => {
        it('replaces items array', () => {
            ...
            const newItems = [{ id: 'new-1', processStepNumber: '20', processDescription: 'New', machineDeviceTool: '', componentMaterial: '', characteristicNumber: '', productCharacteristic: '', processCharacteristic: '', specialCharClass: '', specification: '', evaluationTechnique: '', sampleSize: '', sampleFrequency: '', controlMethod: '', reactionPlan: '', reactionPlanOwner: '', controlProcedure: '' }];
